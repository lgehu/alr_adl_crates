...
package STM32F446.FSMC is
   ...
   subtype BCR1_MBKEN_Field is STM32F446.Bit;
   subtype BCR1_MUXEN_Field is STM32F446.Bit;
   subtype BCR1_MTYP_Field is STM32F446.UInt2;
   subtype BCR1_MWID_Field is STM32F446.UInt2;
   subtype BCR1_FACCEN_Field is STM32F446.Bit;
   subtype BCR1_BURSTEN_Field is STM32F446.Bit;
   subtype BCR1_WAITPOL_Field is STM32F446.Bit;
   subtype BCR1_WAITCFG_Field is STM32F446.Bit;
   subtype BCR1_WREN_Field is STM32F446.Bit;
   subtype BCR1_WAITEN_Field is STM32F446.Bit;
   subtype BCR1_EXTMOD_Field is STM32F446.Bit;
   subtype BCR1_ASYNCWAIT_Field is STM32F446.Bit;
   subtype BCR1_CBURSTRW_Field is STM32F446.Bit;
   subtype BCR1_CCLKEN_Field is STM32F446.Bit;
   ...
   type BCR1_Register is record
      ...
      --  unspecified
      Reserved_7_7   : STM32F446.Bit := 16#1#;
      --  BURSTEN
      ...
      --  unspecified
      Reserved_16_18 : STM32F446.UInt3 := 16#0#;
      --  CBURSTRW
   ...
   subtype BTR_ADDSET_Field is STM32F446.UInt4;
   subtype BTR_ADDHLD_Field is STM32F446.UInt4;
   subtype BTR_DATAST_Field is STM32F446.Byte;
   subtype BTR_BUSTURN_Field is STM32F446.UInt4;
   subtype BTR_CLKDIV_Field is STM32F446.UInt4;
   subtype BTR_DATLAT_Field is STM32F446.UInt4;
   subtype BTR_ACCMOD_Field is STM32F446.UInt2;
   ...
   type BTR_Register is record
      ...
      --  unspecified
      Reserved_30_31 : STM32F446.UInt2 := 16#3#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype BCR_MBKEN_Field is STM32F446.Bit;
   subtype BCR_MUXEN_Field is STM32F446.Bit;
   subtype BCR_MTYP_Field is STM32F446.UInt2;
   subtype BCR_MWID_Field is STM32F446.UInt2;
   subtype BCR_FACCEN_Field is STM32F446.Bit;
   subtype BCR_BURSTEN_Field is STM32F446.Bit;
   subtype BCR_WAITPOL_Field is STM32F446.Bit;
   subtype BCR_WRAPMOD_Field is STM32F446.Bit;
   subtype BCR_WAITCFG_Field is STM32F446.Bit;
   subtype BCR_WREN_Field is STM32F446.Bit;
   subtype BCR_WAITEN_Field is STM32F446.Bit;
   subtype BCR_EXTMOD_Field is STM32F446.Bit;
   subtype BCR_ASYNCWAIT_Field is STM32F446.Bit;
   subtype BCR_CBURSTRW_Field is STM32F446.Bit;
   ...
   subtype PCR_PWAITEN_Field is STM32F446.Bit;
   subtype PCR_PBKEN_Field is STM32F446.Bit;
   subtype PCR_PTYP_Field is STM32F446.Bit;
   subtype PCR_PWID_Field is STM32F446.UInt2;
   subtype PCR_ECCEN_Field is STM32F446.Bit;
   subtype PCR_TCLR_Field is STM32F446.UInt4;
   subtype PCR_TAR_Field is STM32F446.UInt4;
   subtype PCR_ECCPS_Field is STM32F446.UInt3;
   ...
   subtype SR_IRS_Field is STM32F446.Bit;
   subtype SR_ILS_Field is STM32F446.Bit;
   subtype SR_IFS_Field is STM32F446.Bit;
   subtype SR_IREN_Field is STM32F446.Bit;
   subtype SR_ILEN_Field is STM32F446.Bit;
   subtype SR_IFEN_Field is STM32F446.Bit;
   subtype SR_FEMPT_Field is STM32F446.Bit;
   ...
   subtype PMEM_MEMSETx_Field is STM32F446.Byte;
   subtype PMEM_MEMWAITx_Field is STM32F446.Byte;
   subtype PMEM_MEMHOLDx_Field is STM32F446.Byte;
   subtype PMEM_MEMHIZx_Field is STM32F446.Byte;
   ...
   subtype PATT_ATTSETx_Field is STM32F446.Byte;
   subtype PATT_ATTWAITx_Field is STM32F446.Byte;
   subtype PATT_ATTHOLDx_Field is STM32F446.Byte;
   subtype PATT_ATTHIZx_Field is STM32F446.Byte;
   ...
   subtype PIO4_IOSETx_Field is STM32F446.Byte;
   subtype PIO4_IOWAITx_Field is STM32F446.Byte;
   subtype PIO4_IOHOLDx_Field is STM32F446.Byte;
   subtype PIO4_IOHIZx_Field is STM32F446.Byte;
   ...
   subtype BWTR_ADDSET_Field is STM32F446.UInt4;
   subtype BWTR_ADDHLD_Field is STM32F446.UInt4;
   subtype BWTR_DATAST_Field is STM32F446.Byte;
   subtype BWTR_CLKDIV_Field is STM32F446.UInt4;
   subtype BWTR_DATLAT_Field is STM32F446.UInt4;
   subtype BWTR_ACCMOD_Field is STM32F446.UInt2;
   ...
   type BWTR_Register is record
      ...
      --  unspecified
      Reserved_16_19 : STM32F446.UInt4 := 16#F#;
      --  CLKDIV
   ...
   subtype SDCR_NC_Field is STM32F446.UInt2;
   subtype SDCR_NR_Field is STM32F446.UInt2;
   subtype SDCR_MWID_Field is STM32F446.UInt2;
   subtype SDCR_NB_Field is STM32F446.Bit;
   subtype SDCR_CAS_Field is STM32F446.UInt2;
   subtype SDCR_WP_Field is STM32F446.Bit;
   subtype SDCR_SDCLK_Field is STM32F446.UInt2;
   subtype SDCR_RBURST_Field is STM32F446.Bit;
   subtype SDCR_RPIPE_Field is STM32F446.UInt2;
   ...
   subtype SDTR_TMRD_Field is STM32F446.UInt4;
   subtype SDTR_TXSR_Field is STM32F446.UInt4;
   subtype SDTR_TRAS_Field is STM32F446.UInt4;
   subtype SDTR_TRC_Field is STM32F446.UInt4;
   subtype SDTR_TWR_Field is STM32F446.UInt4;
   subtype SDTR_TRP_Field is STM32F446.UInt4;
   subtype SDTR_TRCD_Field is STM32F446.UInt4;
   ...
   subtype SDCMR_MODE_Field is STM32F446.UInt3;
   subtype SDCMR_CTB2_Field is STM32F446.Bit;
   subtype SDCMR_CTB1_Field is STM32F446.Bit;
   subtype SDCMR_NRFS_Field is STM32F446.UInt4;
   subtype SDCMR_MRD_Field is STM32F446.UInt13;
   ...
   subtype SDRTR_CRE_Field is STM32F446.Bit;
   subtype SDRTR_COUNT_Field is STM32F446.UInt13;
   subtype SDRTR_REIE_Field is STM32F446.Bit;
   ...
   subtype SDSR_RE_Field is STM32F446.Bit;
   --  SDSR_MODES array element
   subtype SDSR_MODES_Element is STM32F446.UInt2;
   ...
   subtype SDSR_BUSY_Field is STM32F446.Bit;
   ...
   type FMC_Peripheral is record
      ...
      ECCR2 : aliased STM32F446.UInt32;
      ...
      ECCR3 : aliased STM32F446.UInt32;
