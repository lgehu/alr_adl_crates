...
package STM32F446.RTC is
   ...
   subtype TR_SU_Field is STM32F446.UInt4;
   subtype TR_ST_Field is STM32F446.UInt3;
   subtype TR_MNU_Field is STM32F446.UInt4;
   subtype TR_MNT_Field is STM32F446.UInt3;
   subtype TR_HU_Field is STM32F446.UInt4;
   subtype TR_HT_Field is STM32F446.UInt2;
   subtype TR_PM_Field is STM32F446.Bit;
   ...
   type TR_Register is record
      ...
      PM             : TR_PM_Field := 16#0#;
      --  unspecified
      Reserved_23_31 : STM32F446.UInt9 := 16#0#;
   end record
   ...
   subtype DR_DU_Field is STM32F446.UInt4;
   subtype DR_DT_Field is STM32F446.UInt2;
   subtype DR_MU_Field is STM32F446.UInt4;
   subtype DR_MT_Field is STM32F446.Bit;
   subtype DR_WDU_Field is STM32F446.UInt3;
   subtype DR_YU_Field is STM32F446.UInt4;
   subtype DR_YT_Field is STM32F446.UInt4;
   ...
   subtype CR_WCKSEL_Field is STM32F446.UInt3;
   subtype CR_TSEDGE_Field is STM32F446.Bit;
   subtype CR_REFCKON_Field is STM32F446.Bit;
   subtype CR_FMT_Field is STM32F446.Bit;
   subtype CR_DCE_Field is STM32F446.Bit;
   subtype CR_ALRAE_Field is STM32F446.Bit;
   subtype CR_ALRBE_Field is STM32F446.Bit;
   subtype CR_WUTE_Field is STM32F446.Bit;
   subtype CR_TSE_Field is STM32F446.Bit;
   subtype CR_ALRAIE_Field is STM32F446.Bit;
   subtype CR_ALRBIE_Field is STM32F446.Bit;
   subtype CR_WUTIE_Field is STM32F446.Bit;
   subtype CR_TSIE_Field is STM32F446.Bit;
   subtype CR_ADD1H_Field is STM32F446.Bit;
   subtype CR_SUB1H_Field is STM32F446.Bit;
   subtype CR_BKP_Field is STM32F446.Bit;
   subtype CR_POL_Field is STM32F446.Bit;
   subtype CR_OSEL_Field is STM32F446.UInt2;
   subtype CR_COE_Field is STM32F446.Bit;
   ...
   type CR_Register is record
      ...
      --  unspecified
      Reserved_19_19 : STM32F446.Bit := 16#0#;
      --  Output polarity
   ...
   subtype ISR_ALRAWF_Field is STM32F446.Bit;
   subtype ISR_ALRBWF_Field is STM32F446.Bit;
   subtype ISR_WUTWF_Field is STM32F446.Bit;
   subtype ISR_SHPF_Field is STM32F446.Bit;
   subtype ISR_INITS_Field is STM32F446.Bit;
   subtype ISR_RSF_Field is STM32F446.Bit;
   subtype ISR_INITF_Field is STM32F446.Bit;
   subtype ISR_INIT_Field is STM32F446.Bit;
   subtype ISR_ALRAF_Field is STM32F446.Bit;
   subtype ISR_ALRBF_Field is STM32F446.Bit;
   subtype ISR_WUTF_Field is STM32F446.Bit;
   subtype ISR_TSF_Field is STM32F446.Bit;
   subtype ISR_TSOVF_Field is STM32F446.Bit;
   subtype ISR_TAMP1F_Field is STM32F446.Bit;
   subtype ISR_TAMP2F_Field is STM32F446.Bit;
   subtype ISR_RECALPF_Field is STM32F446.Bit;
   ...
   subtype PRER_PREDIV_S_Field is STM32F446.UInt15;
   subtype PRER_PREDIV_A_Field is STM32F446.UInt7;
   ...
   subtype WUTR_WUT_Field is STM32F446.UInt16;
   ...
   subtype CALIBR_DC_Field is STM32F446.UInt5;
   subtype CALIBR_DCS_Field is STM32F446.Bit;
   ...
   type CALIBR_Register is record
      ...
      --  unspecified
      Reserved_5_6  : STM32F446.UInt2 := 16#0#;
   ...
   subtype ALRMAR_SU_Field is STM32F446.UInt4;
   subtype ALRMAR_ST_Field is STM32F446.UInt3;
   subtype ALRMAR_MSK1_Field is STM32F446.Bit;
   subtype ALRMAR_MNU_Field is STM32F446.UInt4;
   subtype ALRMAR_MNT_Field is STM32F446.UInt3;
   subtype ALRMAR_MSK2_Field is STM32F446.Bit;
   subtype ALRMAR_HU_Field is STM32F446.UInt4;
   subtype ALRMAR_HT_Field is STM32F446.UInt2;
   subtype ALRMAR_PM_Field is STM32F446.Bit;
   subtype ALRMAR_MSK3_Field is STM32F446.Bit;
   subtype ALRMAR_DU_Field is STM32F446.UInt4;
   subtype ALRMAR_DT_Field is STM32F446.UInt2;
   subtype ALRMAR_WDSEL_Field is STM32F446.Bit;
   subtype ALRMAR_MSK4_Field is STM32F446.Bit;
   ...
   subtype ALRMBR_SU_Field is STM32F446.UInt4;
   subtype ALRMBR_ST_Field is STM32F446.UInt3;
   subtype ALRMBR_MSK1_Field is STM32F446.Bit;
   subtype ALRMBR_MNU_Field is STM32F446.UInt4;
   subtype ALRMBR_MNT_Field is STM32F446.UInt3;
   subtype ALRMBR_MSK2_Field is STM32F446.Bit;
   subtype ALRMBR_HU_Field is STM32F446.UInt4;
   subtype ALRMBR_HT_Field is STM32F446.UInt2;
   subtype ALRMBR_PM_Field is STM32F446.Bit;
   subtype ALRMBR_MSK3_Field is STM32F446.Bit;
   subtype ALRMBR_DU_Field is STM32F446.UInt4;
   subtype ALRMBR_DT_Field is STM32F446.UInt2;
   subtype ALRMBR_WDSEL_Field is STM32F446.Bit;
   subtype ALRMBR_MSK4_Field is STM32F446.Bit;
   ...
   subtype WPR_KEY_Field is STM32F446.Byte;
   ...
   subtype SSR_SS_Field is STM32F446.UInt16;
   ...
   subtype SHIFTR_SUBFS_Field is STM32F446.UInt15;
   subtype SHIFTR_ADD1S_Field is STM32F446.Bit;
   ...
   type SHIFTR_Register is record
      ...
      --  unspecified
      Reserved_15_30 : STM32F446.UInt16 := 16#0#;
   ...
   subtype TSTR_TAMP1E_Field is STM32F446.Bit;
   subtype TSTR_TAMP1TRG_Field is STM32F446.Bit;
   subtype TSTR_TAMPIE_Field is STM32F446.Bit;
   subtype TSTR_TAMP1INSEL_Field is STM32F446.Bit;
   subtype TSTR_TSINSEL_Field is STM32F446.Bit;
   subtype TSTR_ALARMOUTTYPE_Field is STM32F446.Bit;
   ...
   type TSTR_Register is record
      ...
      --  unspecified
      Reserved_3_15  : STM32F446.UInt13;
   ...
   subtype TSDR_DU_Field is STM32F446.UInt4;
   subtype TSDR_DT_Field is STM32F446.UInt2;
   subtype TSDR_MU_Field is STM32F446.UInt4;
   subtype TSDR_MT_Field is STM32F446.Bit;
   subtype TSDR_WDU_Field is STM32F446.UInt3;
   ...
   subtype TSSSR_SS_Field is STM32F446.UInt16;
   ...
   subtype CALR_CALM_Field is STM32F446.UInt9;
   subtype CALR_CALW16_Field is STM32F446.Bit;
   subtype CALR_CALW8_Field is STM32F446.Bit;
   subtype CALR_CALP_Field is STM32F446.Bit;
   ...
   type CALR_Register is record
      ...
      --  unspecified
      Reserved_9_12  : STM32F446.UInt4 := 16#0#;
   ...
   subtype TAFCR_TAMP1E_Field is STM32F446.Bit;
   subtype TAFCR_TAMP1TRG_Field is STM32F446.Bit;
   subtype TAFCR_TAMPIE_Field is STM32F446.Bit;
   subtype TAFCR_TAMP2E_Field is STM32F446.Bit;
   subtype TAFCR_TAMP2TRG_Field is STM32F446.Bit;
   subtype TAFCR_TAMPTS_Field is STM32F446.Bit;
   subtype TAFCR_TAMPFREQ_Field is STM32F446.UInt3;
   subtype TAFCR_TAMPFLT_Field is STM32F446.UInt2;
   subtype TAFCR_TAMPPRCH_Field is STM32F446.UInt2;
   subtype TAFCR_TAMPPUDIS_Field is STM32F446.Bit;
   subtype TAFCR_TAMP1INSEL_Field is STM32F446.Bit;
   subtype TAFCR_TSINSEL_Field is STM32F446.Bit;
   subtype TAFCR_ALARMOUTTYPE_Field is STM32F446.Bit;
   ...
   subtype ALRMASSR_SS_Field is STM32F446.UInt15;
   subtype ALRMASSR_MASKSS_Field is STM32F446.UInt4;
   ...
   type ALRMASSR_Register is record
      ...
      --  unspecified
      Reserved_15_23 : STM32F446.UInt9 := 16#0#;
   ...
   subtype ALRMBSSR_SS_Field is STM32F446.UInt15;
   subtype ALRMBSSR_MASKSS_Field is STM32F446.UInt4;
   ...
   type RTC_Peripheral is record
      ...
      --  backup register
      BKP0R    : aliased STM32F446.UInt32;
      --  backup register
      BKP1R    : aliased STM32F446.UInt32;
      --  backup register
      BKP2R    : aliased STM32F446.UInt32;
      --  backup register
      BKP3R    : aliased STM32F446.UInt32;
      --  backup register
      BKP4R    : aliased STM32F446.UInt32;
      --  backup register
      BKP5R    : aliased STM32F446.UInt32;
      --  backup register
      BKP6R    : aliased STM32F446.UInt32;
      --  backup register
      BKP7R    : aliased STM32F446.UInt32;
      --  backup register
      BKP8R    : aliased STM32F446.UInt32;
      --  backup register
      BKP9R    : aliased STM32F446.UInt32;
      --  backup register
      BKP10R   : aliased STM32F446.UInt32;
      --  backup register
      BKP11R   : aliased STM32F446.UInt32;
      --  backup register
      BKP12R   : aliased STM32F446.UInt32;
      --  backup register
      BKP13R   : aliased STM32F446.UInt32;
      --  backup register
      BKP14R   : aliased STM32F446.UInt32;
      --  backup register
      BKP15R   : aliased STM32F446.UInt32;
      --  backup register
      BKP16R   : aliased STM32F446.UInt32;
      --  backup register
      BKP17R   : aliased STM32F446.UInt32;
      --  backup register
      BKP18R   : aliased STM32F446.UInt32;
      --  backup register
      BKP19R   : aliased STM32F446.UInt32;
   end record
     with Volatile;
