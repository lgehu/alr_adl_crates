...
package STM32F446.SYSCFG is
   ...
   subtype MEMRM_MEM_MODE_Field is STM32F446.UInt3;
   subtype MEMRM_FB_MODE_Field is STM32F446.Bit;
   subtype MEMRM_SWP_FMC_Field is STM32F446.UInt2;
   ...
   subtype PMC_ADC1DC2_Field is STM32F446.Bit;
   subtype PMC_ADC2DC2_Field is STM32F446.Bit;
   subtype PMC_ADC3DC2_Field is STM32F446.Bit;
   subtype PMC_MII_RMII_SEL_Field is STM32F446.Bit;
   ...
   type PMC_Register is record
      ...
      --  unspecified
      Reserved_19_22 : STM32F446.UInt4 := 16#0#;
   ...
   subtype EXTICR1_EXTI_Element is STM32F446.UInt4;
   ...
   subtype EXTICR2_EXTI_Element is STM32F446.UInt4;
   ...
   subtype EXTICR3_EXTI_Element is STM32F446.UInt4;
   ...
   subtype EXTICR4_EXTI_Element is STM32F446.UInt4;
   ...
   subtype CMPCR_CMP_PD_Field is STM32F446.Bit;
   subtype CMPCR_READY_Field is STM32F446.Bit;
   ...
   type CMPCR_Register is record
      ...
      --  unspecified
      Reserved_1_7  : STM32F446.UInt7;
      --  Read-only. READY
      READY         : CMPCR_READY_Field;
      --  unspecified
      Reserved_9_31 : STM32F446.UInt23;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
